            ...
            <div class="col-sm-12" >
                ...
                <h1 class="card-inside-title" style="font-size:14px;margin-bottom:3px">Jenis Kelamin</h1>
                    <div class="input-group" style="margin-bottom:0px;">
                        ...
                        <input name="jenis_kelamin" type="radio" id="wanita" class="with-gap radio-col-green" value="Wanita" {{isset($data)?(($data->jenis_kelamin=='Wanita')?'checked':null):null}}/>
            ...
            <div class="col-sm-12" >
                ...
                <h1 class="card-inside-title" style="font-size:14px;">Status Keadaan Keluar</h1>
                    <div class="input-group">
                        ...
                        <input name="status_keadaan_keluar" type="radio" id="Meninggal" class="with-gap radio-col-green" value="Meninggal" {{isset($data)? (($data->status_keadaan_keluar=='Meninggal')?'checked':null): null}}/>
